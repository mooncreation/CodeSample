...
/**
 * CardLess resource functions
 *
 * @package CardLess\Resource
 */

/**
 * CardLess resource class
 *
 */
class CardLess_Resource {
  ...
  public function fetch_sub_resource($type, $params = array()) {
    ...
    // Get class name
    $class = 'CardLess_' .
      CardLess_Utils::camelize(CardLess_Utils::singularize($type));
