...
/**
 * CardLess utility functions
 *
 * @package CardLess\Utils
 */

/**
 * CardLess utils class
 *
 */
class CardLess_Utils {
  ...
  public static function generate_signature($params, $key) {
    ...
    return hash_hmac('sha256',
      CardLess_Utils::generate_query_string($params), $key);
  ...
  public static function generate_query_string($params, &$pairs = array(),
    ...
    if (is_array($params)) {
      ...
      foreach ($params as $k => $v) {
        ...
        if (is_int($k)) {
          CardLess_Utils::generate_query_string($v, $pairs, $namespace .
            '[]');
        } else {
          CardLess_Utils::generate_query_string($v, $pairs,
