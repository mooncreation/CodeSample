...
/**
 * CardLess request functions
 *
 * @package CardLess\Request
 */

/**
 * CardLess request class
 *
 */
class CardLess_Request {
  ...
  protected static function call($method, $url, $params = array()) {
    ...
    $curl_options = array(
      ...
      CURLOPT_TIMEOUT         => 60,
      CURLOPT_USERAGENT       => 'cardless-php/v' . CardLess::VERSION,
    );
    ...
    if ($http_response_code < 200 || $http_response_code > 300) {
      ...
      throw new CardLess_ApiException($message, $http_response_code);
